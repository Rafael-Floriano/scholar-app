  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement>, field: string, addressIndex?: number) => {
    ...
    if (addressIndex !== undefined) {
      setUserData((prevUser) => {
        const newAddresses = [...prevUser.lstAddresses];
            ...
            <Flex direction="column" gap="1vh">
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].street}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  type="text"
                  placeholder="Ex: 123"
                  value={userData.lstAddresses[0].number}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].complement}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].district}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].neighborhood}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].city}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].state}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].country}
              ...
              <Flex align="start" direction="column">
                ...
                <Input
                  ...
                  value={userData.lstAddresses[0].zipCode}
        ...
        <Flex align="center" direction="column" gap="2vh">
          ...
          <Flex direction="row" gap="5vw">
            ...
            <Flex direction="column" gap="1.5vh">
              ...
              <Flex gap="5vw">
                <Text fontSize='2xl'>Rua: {verificarCampo(userData.lstAddresses[0].street)}</Text>
                <Text fontSize='2xl'>Número: {verificarCampo(userData.lstAddresses[0].number)}</Text>
                <Text fontSize='2xl'>Complemento: {verificarCampo(userData.lstAddresses[0].complement)}</Text>
              </Flex>
              <Flex gap="5vw">
                <Text fontSize='2xl'>Distrito: {verificarCampo(userData.lstAddresses[0].district)}</Text>
                <Text fontSize='2xl'>Bairro: {verificarCampo(userData.lstAddresses[0].neighborhood)}</Text>
                <Text fontSize='2xl'>Cidade: {verificarCampo(userData.lstAddresses[0].city)}</Text>
              </Flex>
              <Flex gap="5vw">
                <Text fontSize='2xl'>Estado: {verificarCampo(userData.lstAddresses[0].state)}</Text>
                <Text fontSize='2xl'>País: {verificarCampo(userData.lstAddresses[0].country)}</Text>
                <Text fontSize='2xl'>Código Postal: {verificarCampo(userData.lstAddresses[0].zipCode)}</Text>
              </Flex>
            </Flex>
          </Flex>
        </Flex>
